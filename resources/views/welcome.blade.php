...
<form>
  ...
  <input type="text" id="name" name="fname" placeholder="enter name"><br><br>
  
  <label for="offices">Number of Offices:</label>
  <input type="number" id="offices" name="quantity" min="1" ><br><br>
  <label for="tables">Number of tables:</label>
  <input type="number" id="tables" name="quantity" min="1"><br><br>
  <label for="sqm">Square meters range between</label>
  <input type="number" id="sqm" name="quantity" min="1">
  <label> and </label> 
  <input type="number" id="quantity" name="quantity" min="1"> <br><br>
  <label for="price">Price range between</label>
  <input type="number" id="price" name="quantity" min="1">
  <label> and </label> 
  <input type="number" id="quantity" name="quantity" min="1"> <br><br>
  </form>
  <p id="demo"></p>
